...
$string['privacy:metadata:aiprovider_datacurso_rl'] = 'Per-user per-service rate limit rolling usage state stored locally.';
$string['privacy:metadata:aiprovider_datacurso_rl:userid'] = 'User ID related to the tracked consumption window.';
$string['privacy:metadata:aiprovider_datacurso_rl:serviceid'] = 'Service identifier (e.g. local_coursegen).';
$string['privacy:metadata:aiprovider_datacurso_rl:windowstart'] = 'Window start timestamp used to compute consumption limits.';
$string['privacy:metadata:aiprovider_datacurso_rl:tokensused'] = 'Credits used within the current time window.';
$string['privacy:metadata:aiprovider_datacurso_rl:lastsync'] = 'Last sync timestamp with the remote history.';
$string['privacy:metadata:aiprovider_datacurso_rl:timecreated'] = 'Time when this record was created.';
$string['privacy:metadata:aiprovider_datacurso_rl:timemodified'] = 'Time when this record was last modified.';
