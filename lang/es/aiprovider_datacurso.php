...
$string['ratelimit_enable'] = 'Habilitar límite de tasa';
$string['ratelimit_enable_desc'] = 'Si está habilitado, se aplicará el límite de crédito por usuario para este plugin.';
$string['ratelimit_limit'] = 'Límite de tasa';
$string['ratelimit_limit_desc'] = 'El número máximo de solicitudes permitidas por ventana de límite de tasa.';
