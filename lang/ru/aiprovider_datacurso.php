...
$string['create_activity_assign'] = 'Создать задание с помощью ИИ';
$string['create_activity_book'] = 'Создать книгу с помощью ИИ';
$string['create_activity_choice'] = 'Создать голосование с помощью ИИ';
$string['create_activity_data'] = 'Создать базу данных с помощью ИИ';
$string['create_activity_feedback'] = 'Создать опрос с помощью ИИ';
$string['create_activity_folder'] = 'Создать папку с помощью ИИ';
$string['create_activity_forum'] = 'Создать форум с помощью ИИ';
$string['create_activity_glossary'] = 'Создать глоссарий с помощью ИИ';
$string['create_activity_h5pactivity'] = 'Создать H5P активность с помощью ИИ';
$string['create_activity_imscp'] = 'Создать IMS пакет с помощью ИИ';
$string['create_activity_label'] = 'Создать метку с помощью ИИ';
$string['create_activity_lesson'] = 'Создать урок с помощью ИИ';
$string['create_activity_page'] = 'Создать страницу с помощью ИИ';
$string['create_activity_quiz'] = 'Создать тест с помощью ИИ';
$string['create_activity_resource'] = 'Создать файл/ресурс с помощью ИИ';
$string['create_activity_scorm'] = 'Создать SCORM пакет с помощью ИИ';
$string['create_activity_url'] = 'Создать URL с помощью ИИ';
$string['create_activity_wiki'] = 'Создать вики с помощью ИИ';
$string['create_activity_workshop'] = 'Создать семинар с помощью ИИ';
