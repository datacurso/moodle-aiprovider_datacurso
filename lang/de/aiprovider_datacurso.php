...
$string['create_activity_assign'] = 'Aufgabe mit KI erstellen';
$string['create_activity_book'] = 'Buch mit KI erstellen';
$string['create_activity_choice'] = 'Abstimmung mit KI erstellen';
$string['create_activity_data'] = 'Datenbank mit KI erstellen';
$string['create_activity_feedback'] = 'Umfrage mit KI erstellen';
$string['create_activity_folder'] = 'Ordner mit KI erstellen';
$string['create_activity_forum'] = 'Forum mit KI erstellen';
$string['create_activity_glossary'] = 'Glossar mit KI erstellen';
$string['create_activity_h5pactivity'] = 'H5P-Aktivität mit KI erstellen';
$string['create_activity_imscp'] = 'IMS-Paket mit KI erstellen';
$string['create_activity_label'] = 'Label mit KI erstellen';
$string['create_activity_lesson'] = 'Lektion mit KI erstellen';
$string['create_activity_page'] = 'Seite mit KI erstellen';
$string['create_activity_quiz'] = 'Quiz mit KI erstellen';
$string['create_activity_resource'] = 'Datei/Ressource mit KI erstellen';
$string['create_activity_scorm'] = 'SCORM-Paket mit KI erstellen';
$string['create_activity_url'] = 'URL mit KI erstellen';
$string['create_activity_wiki'] = 'Wiki mit KI erstellen';
$string['create_activity_workshop'] = 'Workshop mit KI erstellen';
