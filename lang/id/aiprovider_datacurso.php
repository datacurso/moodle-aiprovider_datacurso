...
$string['confirm_delete_message'] = 'Apakah Anda benar-benar ingin menghapus batas kredit untuk "{$a}"?';
...
$string['exists'] = 'Ada';
$string['forbidden'] = 'Anda tidak diizinkan melakukan tindakan ini dengan lisensi saat ini. Harap verifikasi lisensi dan kredit yang tersedia Anda di <a href="https://shop.datacurso.com/index.php?m=tokens_manager" target="_blank">Kelola Kredit</a> di Datacurso Shop.';
...
$string['hour'] = 'jam';
$string['hours'] = 'Jam';
$string['httperror'] = 'Terjadi kesalahan tak terduga saat memproses permintaan Anda (HTTP {$a}). Silakan coba lagi nanti. Jika masalah berlanjut, hubungi administrator situs Anda.';
$string['id'] = 'ID';
...
$string['invalidlicensekey'] = 'Kunci lisensi telah kedaluwarsa atau tidak valid. Silakan buka <a href="https://shop.datacurso.com/index.php?m=tokens_manager" target="_blank">Kelola Kredit</a> di Datacurso Shop untuk memperbarui atau membeli lisensi baru.';
$string['json_encode_failed'] = 'Gagal Pengodean Json';
$string['jsondecodeerror'] = 'Kesalahan saat memproses respons dari API Datacurso: {$a}';
$string['last_sent'] = 'Terakhir dikirim';
$string['license_not_allowed'] = 'Lisensi Anda tidak diizinkan untuk melakukan permintaan ini. Harap kelola lisensi dan kredit Anda di <a href="https://shop.datacurso.com/index.php?m=tokens_manager" target="_blank">Kelola Kredit</a> di Datacurso Shop.';
$string['licensekey'] = 'Kunci lisensi';
$string['licensekey_desc'] = 'Masukkan kunci lisensi dari area pelanggan Datacurso Shop.';
...
$string['link_webservice_config'] = 'Penyiapan webservice Datacurso';
...
$string['month'] = 'bulan';
$string['months'] = 'Bulan';
$string['needs_repair'] = 'Membutuhkan perbaikan';
$string['nodata'] = 'Tidak ada informasi ditemukan';
$string['not_assigned'] = 'Tidak ditugaskan';
$string['not_configured'] = 'Belum dikonfigurasi';
$string['not_created'] = 'Belum dibuat';
...
$string['notenoughtokens'] = 'Kredit AI tidak mencukupi. Silakan kunjungi <a href="https://shop.datacurso.com/index.php?m=tokens_manager" target="_blank">Kelola Kredit</a> di Datacurso Shop untuk mengalokasikan atau membeli lebih banyak kredit. Atau hubungi administrator Anda.';
$string['of'] = 'dari';
$string['orgid'] = 'ID Organisasi';
$string['orgid_desc'] = 'Masukkan pengenal organisasi Anda dalam layanan Datacurso.';
$string['pageinfo'] = 'Halaman {$a->current} dari {$a->totalpages} ({$a->total} catatan)';
...
$string['plugindesc_dttutor'] = 'Mengobrol dengan tutor AI di dalam kursus.';
$string['plugindesc_forum_ai'] = 'Memperluas forum dengan analisis bertenaga AI untuk secara otomatis menghasilkan ringkasan.';
...
$string['plugindesc_socialcert'] = 'Secara otomatis menghasilkan sertifikat yang dipersonalisasi setelah kursus selesai.';
...
$string['privacy:metadata'] = 'Plugin Penyedia AI Datacurso tidak menyimpan data pribadi apa pun secara lokal. Semua data diproses oleh layanan AI Datacurso eksternal.';
$string['privacy:metadata:aiprovider_datacurso'] = 'Payload permintaan AI Datacurso yang dikirim ke layanan eksternal.';
...
$string['ratelimit_limit'] = 'Batas kredit per jendela';
$string['ratelimit_limit_desc'] = 'Jumlah maksimum kredit yang dapat dikonsumsi pengguna dalam jendela waktu yang dipilih. 0 untuk tak terbatas.';
...
$string['ratelimit_local_assign_ai_allowedusers_desc_help'] = 'Pengaturan ini menentukan daftar pengguna tertentu yang dikecualikan dari batas kecepatan global untuk layanan AI ini, hanya mengizinkan mereka untuk menghasilkan penilaian atau umpan balik berbasis AI untuk tugas Moodle.';
...
$string['ratelimit_local_coursegen_allowedusers_enable_desc'] = 'Jika diaktifkan, hanya pengguna yang dipilih di bawah ini yang diizinkan menggunakan layanan ini.';
...
$string['ratelimit_report_lifestory_allowedusers_enable_desc'] = 'Jika diaktifkan, hanya pengguna yang dipilih di bawah ini yang diizinkan untuk menghasilkan umpan balik AI dalam laporan Kisah Hidup Siswa.';
...
$string['ratelimits_heading_desc'] = 'Konfigurasi batas kecepatan per pengguna per plugin yang menggunakan penyedia Datacurso.';
...
$string['registration_notverified'] = 'Pendaftaran belum diverifikasi';
...
$string['tokensconsumed'] = 'Kredit yang dikonsumsi';
$string['tokensconsumedday'] = 'Kredit yang dikonsumsi per hari';
$string['tokensconsumedmonth'] = 'Kredit yang dikonsumsi per bulan';
$string['tokensnotsufficient'] = 'Kredit AI tidak mencukupi. Saldo saat ini: {$a->current}. Minimal diperlukan: {$a->required}. Silakan kunjungi <a href="https://shop.datacurso.com/index.php?m=tokens_manager" target="_blank">Kelola Kredit</a> di Datacurso Shop untuk mengalokasikan atau membeli lebih banyak kredit. Atau hubungi administrator Anda.';
$string['tokensused'] = 'Kredit yang digunakan';
$string['tokenthreshold'] = 'Ambang batas kredit';
$string['tokenthreshold_desc'] = 'Jumlah kredit yang akan menampilkan notifikasi untuk membeli lebih banyak.';
$string['total_consumed'] = 'Kredit yang dikonsumsi';
...
string['usertokenlimit_limit_help'] = 'Masukkan jumlah maksimum kredit yang diizinkan untuk dikonsumsi pengguna. Nilai harus lebih besar dari nol.';
$string['usertokenlimit_limit_invalid'] = 'Batas harus berupa angka positif yang lebih besar dari nol.';
...
$string['usertokenlimit_reset_help'] = 'Jika diaktifkan, penghitung penggunaan saat ini untuk pengguna ini akan segera diatur ulang setelah menyimpan.';
$string['usertokenlimit_reset_usage'] = 'Atur ulang penggunaan';
$string['usertokenlimit_saved'] = 'Batas kredit pengguna disimpan';
$string['usertokenlimit_used'] = 'Kredit yang digunakan';
$string['usertokenlimit_user'] = 'Pengguna';
$string['usertokenlimit_user_help'] = 'Pilih pengguna yang akan dikenakan batas kredit.';
$string['usertokenlimit_user_readonly'] = 'Pengguna';
$string['usertokenlimit_user_readonly_help'] = 'Pengguna ini ditetapkan untuk catatan yang sudah ada dan tidak dapat diubah.';
...
$string['webserviceconfig_desc'] = 'Secara otomatis mengkonfigurasi layanan web khusus untuk layanan AI Datacurso, memungkinkannya untuk mengekstrak informasi platform seperti data dasar pengguna, kursus, dan aktivitas secara aman untuk kontekstualisasi AI yang lebih baik. Penyiapan ini membuat pengguna layanan, menetapkan peran yang diperlukan, mengkonfigurasi layanan eksternal, menghasilkan token aman, dan mengaktifkan protokol REST dalam satu klik. Catatan: Nilai token tidak ditampilkan karena alasan keamanan.';
$string['webserviceconfig_heading'] = 'Penyiapan webservice otomatis';
...
$string['ws_error_regenerate_token'] = 'Kesalahan saat membuat ulang token.';
$string['ws_error_registration'] = 'Kesalahan saat mendaftarkan token webservice.';
$string['ws_error_setup'] = 'Kesalahan saat mengkonfigurasi webservice.';
