...
$string['create_activity_assign'] = 'Créer un devoir avec IA';
$string['create_activity_book'] = 'Créer un livre avec IA';
$string['create_activity_choice'] = 'Créer un choix avec IA';
$string['create_activity_data'] = 'Créer une base de données avec IA';
$string['create_activity_feedback'] = 'Créer un sondage avec IA';
$string['create_activity_folder'] = 'Créer un dossier avec IA';
$string['create_activity_forum'] = 'Créer un forum avec IA';
$string['create_activity_glossary'] = 'Créer un glossaire avec IA';
$string['create_activity_h5pactivity'] = 'Créer une activité H5P avec IA';
$string['create_activity_imscp'] = 'Créer un paquet IMS avec IA';
$string['create_activity_label'] = 'Créer une étiquette avec IA';
$string['create_activity_lesson'] = 'Créer une leçon avec IA';
$string['create_activity_page'] = 'Créer une page avec IA';
$string['create_activity_quiz'] = 'Créer un quiz avec IA';
$string['create_activity_resource'] = 'Créer un fichier/ressource avec IA';
$string['create_activity_scorm'] = 'Créer un paquet SCORM avec IA';
$string['create_activity_url'] = 'Créer une URL avec IA';
$string['create_activity_wiki'] = 'Créer un wiki avec IA';
$string['create_activity_workshop'] = 'Créer un atelier avec IA';
$string['created'] = 'Créé';
