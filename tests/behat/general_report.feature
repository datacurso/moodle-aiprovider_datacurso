@aiprovider @aiprovider_datacurso @javascript
Feature: General consumption report tab
  ...
  Scenario: Year selector and credit cards are shown
    ...
    And I should see "2030" in the "#tokens-consumed" "css_element"

  Scenario: The four consumption charts are rendered
    When I set the field "Year" to "2026"
    Then "Number of credits consumed per month" "text" should exist
    And "Credits distribution by service" "text" should exist
    And "Credits consumed by user per service" "text" should exist
    And "Credits consumption by day" "text" should exist
